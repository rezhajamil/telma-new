...
<body class="font-sans antialiased bg-slate-800">
    <nav class=" bg-slate-800 border-b-2 border-shadow border-sky-400">
            ...
            <div class="flex h-16">
                <div class="flex w-full justify-center">
                    ...
                    <div class="shrink-0 flex justify-between w-full items-center">
                        ...
                        <span class="text-2xl text-sky-400 font-batik font-bold">
    ...
    <div class="relativew-full bg-[url('/images/wave-dark-orange4.svg')] bg-no-repeat bg-cover md:h-[50vh] sm:h-lvw overflow-hidden">
        <span class="inline-block w-full mt-[1.55rem] text-2xl text-center sm:text-4xl font-batik text-orange-500">
            DAFTAR SEKARANG
        </span>
        <div
            class="relative w-full md:h-[50vh] sm:h-lvw overflow-hidden">
            <form method="POST" action="{{ route('telma.store') }}" class="mx-auto w-fit flex flex-col gap-6 mt-12 ">
                @csrf
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                        <input type="text" id="kampus_id"
                            class="form-input w-[280px] gap-2 rounded border-2 border-orange-400 text-sm py-2.5"
                            name="kampus_id" placeholder="Masukkan NPSM Sekolah">
                        <div>
                            <button class=" flex items-center gap-2 mt-1 ml-1 text-sm underline text-orange-500"
                                onclick="openModal(event)">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-4 h-4 stroke-blue">
                            ...
                            <div id="myModal"
                                ...
                                <div class="bg-white rounded shadow-lg w-3/4 lg:h-4/5 sm:h-2/5">
                                    <div
                                    ...
                                    <div class="m-3 overflow-y-auto lg:max-h-96 sm:h-full" id="kampusList">
                    ...
                    <div>
                        <select name="semester"
                            class="form-multiselect w-[280px] gap-2 rounded border-2 border-orange-400 text-sm py-2">
                            @for ($i = 1; $i <= 14; $i++)
                    ...
                    <div>
                        <input type="text" class="w-[280px] gap-2 rounded border-2 border-orange-400 text-sm py-2.5"
                            name="nama_lengkap" placeholder="Nama Lengkap">
                    </div>
                    <div>
                        <input type="email" class="w-[280px] gap-2 rounded border-2 border-orange-400 text-sm py-2.5"
                    ...
                    <div>
                        <input type="text" class="w-[280px] gap-2 rounded border-2 border-orange-400 text-sm py-2.5"
                        name="hobi" placeholder="Tuliskan Hobimu">
                    </div>
                </div>
                <div class="w-full mb-5">
                    <button type="submit"
                        class="w-full bg-orange-500 border-2 border-white p-2.5 rounded uppercase font-bold text-white hover:bg-white hover:text-orange-500 hover:border-2 hover:border-orange-400 transition-all">
                        Daftar
                    </button>
                </div>
            </form>
